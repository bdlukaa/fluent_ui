...
void main() {
  ...
  group(
    'Issue - NavigationView compact pane flyout in RTL directionality',
    () {
      testWidgets(
        'PaneItemExpander flyout opens correctly in RTL compact mode',
        (tester) async {
          await tester.pumpWidget(
            FluentApp(
              home: Directionality(
          ...
          final flyoutBox =
              tester.renderObject<RenderBox>(find.byType(MenuFlyout));
          expect(
            flyoutBox.size.width,
            greaterThan(kCompactNavigationPaneWidth),
          );
        },
      );
    },
