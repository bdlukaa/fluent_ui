...
void main() {
  testWidgets('Card renders with default values', (WidgetTester tester) async {
    ...
    expect(
        decoration.borderRadius, const BorderRadius.all(Radius.circular(4.0)));
  ...
  testWidgets('Card uses theme cardColor when background color is not provided',
      (WidgetTester tester) async {
  ...
  testWidgets('Card uses theme border color when not provided',
    ...
    final decoration = container.decoration as BoxDecoration;
    expect(
        decoration.border?.top.color, theme.resources.cardStrokeColorDefault);
  });
